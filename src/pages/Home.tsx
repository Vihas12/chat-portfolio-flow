...
import { ArrowRight, Code, Bot, Sparkles } from "lucide-react";
...
const Home = () => {
  ...
  const services = [
    ...
    },
    {
      title: "AI-Driven UX",
      icon: Bot,
      description: "Crafting intelligent user interfaces powered by AI for personalized and seamless user experiences.",
      ...
      <section className="min-h-screen relative flex flex-col justify-center pt-20 pb-16 px-4">
        <div className="container mx-auto relative z-10">
          ...
          >
            ...
            <motion.h1
              variants={childVariants}
              className="text-4xl md:text-6xl lg:text-7xl font-bold text-portfolio-black dark:text-portfolio-lightest transition-colors duration-300"
            >
              Vihas Poojari
            </motion.h1>
            <motion.h2
            ...
            <motion.div variants={childVariants} className="mt-10">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="btn-primary dark:btn-primary flex items-center border  text-black bg-white border-black hover:bg-black hover:text-white transition-colors duration-300"
              >
                  View My Work
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="h-12 w-12 bg-portfolio-teal/10 flex items-center justify-center rounded-lg mb-4">
                  <service.icon className="dark:text-portfolio-teal" size={24} />
                </div>
          ...
          >
            ...
            <Link to="/contact">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="btn-primary dark:btn-primary dark:text-lg dark:px-8 dark:py-4 text-lg px-8 py-4  text-black bg-white border-black hover:bg-black hover:text-white transition-colors duration-300 "
              >
                Get In Touch
              </motion.button>
            </Link>
