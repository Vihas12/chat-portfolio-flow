          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="bg-portfolio-teal/10 p-3 rounded-lg mr-4">
                  <Mail className="text-portfolio-teal" size={24} />
                </div>
                <div>
                  <h3 className="font-medium">Email</h3>
                  <p className="text-portfolio-light">contact@example.com</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-portfolio-teal/10 p-3 rounded-lg mr-4">
                  <Phone className="text-portfolio-teal" size={24} />
                </div>
                <div>
                  <h3 className="font-medium">Phone</h3>
                  <p className="text-portfolio-light">+1 (555) 123-4567</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <div className="bg-portfolio-teal/10 p-3 rounded-lg mr-4">
                  <MapPin className="text-portfolio-teal" size={24} />
                </div>
                <div>
                  <h3 className="font-medium">Location</h3>
                  <p className="text-portfolio-light">San Francisco, CA</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-portfolio-navy p-3 rounded-lg hover:bg-portfolio-teal/10 transition-colors"
                >
                  <svg className="w-5 h-5 text-portfolio-teal" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
